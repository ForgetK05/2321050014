...
<body>
    ...
    ?>
    <div class="container">
        <form action="index.php?page_layout=updatephim&id=<?php echo $phim["id"] ?>" method="post" enctype="multipart/form-data">
            <h1>Cập nhật phim</h1>
            <div>
            ...
            <div>
                <input type="number" name="nam_phat_hanh" placeholder="Năm phát hành" value="<?php echo $phim['nam_phat_hanh'] ?>">
            </div>
            <div>
